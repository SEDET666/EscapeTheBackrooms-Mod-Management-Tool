...
LANG_DATA = {
    "zh": {"app_title":"逃离后室 - 工具箱","nav_mod":"Mod 管理","nav_ue4ss":"UE4SS 安装","nav_about":"关于","nav_setting":"设置","btn_install":"安装 Mod (.pak)","btn_refresh":"刷新列表","btn_delete":"删除 Mod","table_name":"文件名","table_path":"所在路径","table_root":"根目录","ctx_delete":"删除选中的 Mod","msg_err_path":"找不到游戏路径或 Paks 文件夹，请确认游戏是否已安装！","msg_no_mod":"当前没有安装任何 Mod。","msg_select_mod":"请先在列表中选择要删除的 Mod！","msg_del_success":"已成功删除 {count} 个 Mod。","msg_del_fail":"文件 {name} 删除失败(可能被占用): {err}","msg_install_success":"已成功安装 {count} 个 Mod 到 LogicMods 文件夹。","msg_copy_fail":"文件 {name} 复制失败: {err}","msg_install_title":"安装成功","msg_delete_title":"删除成功","msg_drop_err":"仅支持拖入 .pak 文件！","ue4ss_title":"UE4SS 自动下载与安装","btn_fetch":"获取在线版本列表","btn_dl_install":"下载并自动安装","btn_dl_save":"下载到指定位置(不安装)","msg_fetching":"正在连接 GitHub 获取版本列表，请稍候...","msg_fetch_success":"获取到 {count} 个可用版本，请选择后操作。","msg_select_ver":"请先获取列表并选择一个版本！","msg_downloading":"正在下载中，请等待完成！","msg_installing":"下载完成，正在解压覆盖到游戏目录，请稍候...","msg_install_ok":"UE4SS 已成功安装到:\n{path}","msg_install_err":"解压时出错(可能文件被占用): {err}\n临时文件保留在: {path}","msg_save_ok":"文件已保存到:\n{path}","msg_no_release":"未找到可用的发行版","ctx_dl_install":"下载并自动安装","ctx_dl_save":"下载到指定位置","setting_theme":"外观设置","setting_theme_label":"主题模式：","setting_path":"游戏路径设置","setting_path_label":"安装目录:","setting_path_tip":"修改路径后，切换到其他页面即可生效。留空则自动读取 Steam 注册表。","setting_browse":"浏览","setting_lang":"语言设置 / Language","setting_lang_label":"界面语言：","msg_path_err":"该目录下未找到 Content 文件夹，请确认是否选对了 EscapeTheBackrooms 目录！","msg_path_ok":"游戏路径已更新，切换到其他页面即可生效。","msg_path_select":"选择 EscapeTheBackrooms 文件夹","msg_path_placeholder":"未检测到游戏路径","theme_system":"跟随系统","theme_light":"浅色模式","theme_dark":"深色模式","about_title":"逃离后室 - 工具箱(Ver:1.0)","about_dev":"开发者：SEDET","about_qq":"开发者QQ：248881284","about_group":"交流群："},
    "en": {"app_title":"Escape The Backrooms - ToolBox","nav_mod":"Mod Manager","nav_ue4ss":"UE4SS Install","nav_about":"About","nav_setting":"Settings","btn_install":"Install Mod (.pak)","btn_refresh":"Refresh List","btn_delete":"Delete Mod","table_name":"File Name","table_path":"Location","table_root":"Root","ctx_delete":"Delete Selected Mods","msg_err_path":"Game path or Paks folder not found!","msg_no_mod":"No mods installed currently.","msg_select_mod":"Please select mods to delete first!","msg_del_success":"Successfully deleted {count} mod(s).","msg_del_fail":"Failed to delete {name}: {err}","msg_install_success":"Successfully installed {count} mod(s) to LogicMods.","msg_copy_fail":"Failed to copy {name}: {err}","msg_install_title":"Install Success","msg_delete_title":"Delete Success","msg_drop_err":"Only .pak files are supported!","ue4ss_title":"UE4SS Auto Download & Install","btn_fetch":"Fetch Online Versions","btn_dl_install":"Download & Install","btn_dl_save":"Save to Location","msg_fetching":"Connecting to GitHub, please wait...","msg_fetch_success":"Found {count} versions available.","msg_select_ver":"Please fetch and select a version first!","msg_downloading":"Currently downloading, please wait!","msg_installing":"Download complete, extracting to game directory...","msg_install_ok":"UE4SS installed successfully to:\n{path}","msg_install_err":"Extraction error (file in use?): {err}\nTemp file saved at: {path}","msg_save_ok":"File saved to:\n{path}","msg_no_release":"No available releases found","ctx_dl_install":"Download & Install","ctx_dl_save":"Save to Location","setting_theme":"Appearance","setting_theme_label":"Theme Mode:","setting_path":"Game Path Settings","setting_path_label":"Install Dir:","setting_path_tip":"Changes take effect after switching pages. Leave blank to auto-detect via Steam registry.","setting_browse":"Browse","setting_lang":"Language Settings","setting_lang_label":"UI Language:","msg_path_err":"Content folder not found! Did you select the correct EscapeTheBackrooms directory?","msg_path_ok":"Game path updated, switch pages to apply.","msg_path_select":"Select EscapeTheBackrooms Folder","msg_path_placeholder":"Game path not detected","theme_system":"Follow System","theme_light":"Light Mode","theme_dark":"Dark Mode","about_title":"Escape The Backrooms - ToolBox(Ver:1.0)","about_dev":"Developer: SEDT","about_qq":"Developer QQ: 248881284","about_group":"QQ Group: "}
}
...
class MainWindow(FluentWindow):
    ...
    def update_all_ui_language(self):
        ...
        if hasattr(self, 'navigationInterface'):
            for n, k in [("ModManagerInterface","nav_mod"),("UE4SSInterface","nav_ue4ss"),("AboutInterface","nav_about"),("SettingInterface","nav_setting")]:
